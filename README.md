...
Если бы переделывал - с удовольствием бы реализовал функции, которые не успел. А если бы к заданию давался фронт, написал бы все по API, думаю было бы изящнее.
